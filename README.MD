...
@REM # 2. شغّل الأمر
@REM pyinstaller --onefile --windowed --noconsole --name="InventorySystem" inventory.py
...
<!-- 
# 1. ثبت المكتبات
pip3 install reportlab pyinstaller

# 2. ابنِ البرنامج
pyinstaller --onefile --windowed inventory.py

# 3. شغّل البرنامج
chmod +x dist/inventory
./dist/inventory -->
