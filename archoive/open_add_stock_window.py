...
from utils.dp_utils import update_product_quantities 
from constants.index import Fields,  FONT

def open_add_stock_window(root, tree, load_data_func, search_term, stat_vars):
    sel = tree.selection()
    if not sel:
